...
// P9_15 (button) gets copied to P9_16 (LED). Note that I had to alter the pushbutton to a pull-down configuration on the breadboard, as P9_15 appears to float to a high value.
